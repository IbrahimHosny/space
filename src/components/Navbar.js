...
const Navbar = () => {
    ...
    return ( 
        ...
        <li onClick={clickHandler} className="flex items-center max-sm:mt-[100px] max-sm:mb-[30px] max-sm:ms-[15px] sm:h-full"><Link to="/space/"><span>00</span> HOME</Link></li>
        <li onClick={clickHandler} className="flex items-center max-sm:my-[30px] max-sm:ms-[15px] sm:h-full"><Link to="/space/destination"><span>00</span> DESTINATION</Link></li>
        <li onClick={clickHandler} className="flex items-center max-sm:my-[30px] max-sm:ms-[15px] sm:h-full"><Link to="/space/crew"><span>00</span> CREW</Link> </li>
        <li onClick={clickHandler} className="flex items-center max-sm:my-[30px] max-sm:ms-[15px] sm:h-full"><Link to="/space/technology"><span>00</span> TECHNOLOGY</Link></li>
        </ul>
        </nav>
        </Fragment>
    );
